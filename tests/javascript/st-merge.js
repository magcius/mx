...
const cssStylesheet = "../../data/style/st-style.css";
let theme = new Mx.StTheme ({ application_stylesheet: cssStylesheet });

Mx.StThemeContext.get_for_stage(stage).set_theme (theme);
